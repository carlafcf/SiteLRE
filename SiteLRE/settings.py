"""
Django settings for SiteLRE project.
...
SECRET_KEY = 'django-insecure-5qwd=^9e9oyv(2)a3(n1z6$*+cl@3fe(gbfx7gwc+r=!n4v(0%'
...
WSGI_APPLICATION = 'SiteLRE.wsgi.application'
